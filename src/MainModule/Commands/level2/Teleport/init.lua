...
Command.aliases	= {"TP"} -- additional names (typically shorthand) which activate the command
...
Command.args = {"Player", "Players"} -- the arguments to be processed and passed through the the command; see the 'Args' module for a list of all arguments

function Command:invoke(task, args)
	local playerToTeleport, targetPlayers = table.unpack(args)
