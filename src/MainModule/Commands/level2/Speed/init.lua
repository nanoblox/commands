...
Command.aliases	= {"WalkSpeed", "WS"} -- additional names (typically shorthand) which activate the command
...
Command.args = {"Player", "Number"} -- the arguments to be processed and passed through the the command; see the 'Args' module for a list of all arguments
