...
Command.autoPreview = true -- preview the commands menu before executing
...
Command.args = {"PlayerOrUser", "Duration", "Reason"} -- the arguments to be processed and passed through the the command; see the 'Args' module for a list of all arguments
